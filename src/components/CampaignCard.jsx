    ...
    <div className="campaign-card">
      ...
      <div className="campaign-actions">
        ...
        <button
          ...
          title="Edit campaign"
          style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', background: 'rgba(108, 71, 255, 0.1)', color: '#a78bfa', borderRadius: '6px', fontWeight: '500', fontSize: '13px' }}
        >
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', borderRadius: '6px', fontWeight: '500', fontSize: '13px' }}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="14" height="14">
